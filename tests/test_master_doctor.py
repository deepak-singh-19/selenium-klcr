...
def generate_random_doctor_data():
    ...
    data = {
        "name": fake.name(),
        "registration_number": str(fake.random_int(min=100000000000, max=999999999999)),
...
def test_open_doctor_page(driver):
    # ── 1. Sign in ─────────────────────────────────────────────
    ...
    time.sleep(3)
    driver.find_element(By.XPATH, '/html/body/div[2]/div[3]/div/div[2]/form/div/div[1]/div[2]/div/div/div/input').send_keys(user_data['registration_number'])
    time.sleep(3)
    driver.find_element(By.XPATH, '/html/body/div[2]/div[3]/div/div[2]/form/div/div[1]/div[3]/div/div[2]/div/div/input').click()
    time.sleep(2)
    driver.find_element(By.XPATH, '/html/body/div[2]/div[3]/div/div[2]/form/div/div[1]/div[4]/div/div/div/input').send_keys((user_data['contact_number']))
    time.sleep(3)
    driver.find_element(By.XPATH, '/html/body/div[2]/div[3]/div/div[2]/form/div/div[1]/div[5]/div/div/input').send_keys(user_data['address'])
    time.sleep(3)

    #---- save the doctor details
    driver.find_element(By.ID, ":r36:").click()
    time.sleep(2)
